	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="popup.php">
				...
				<span align="center" class="input100" type="text"> Muchas gracias por tu interés en Lottus.Dejanos tu nombre y correo si quiéres ser el primero/a en saber cuando esten disponibles. ¡Te enviaremos un cupón de descuento junto con el correo, para agradecerte el interés!</span>
				<br><br><br>
