		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="popup.php">
				<span class="contact100-form-title">
					¡ Nuestra fase beta está completa!
					<?php include('errors.php'); ?>
				</span>
				<span align="center" class="input100" type="text"> Muchas gracias por tu interés en Lottus.Dejanos tu nombre y correo si quiéres ser el primero/a en saber cuando la fase final ese completa. ¡Te enviaremos un correo para que puedas descargarla y un cupón de descuento para conseguir nuestro botón inteligente !</span>
				<br><br><br>
			...
			<div class="contact100-more">
				¿Tienes dudas?<span class="contact100-more-highlight">+34 693 430 654</span> Llámanos
			</div>

			<div class="contact100-more" >
				<a class="contact100-more-highlight" href="index.php"> Volver a la página principal</a>
			</div>
		</div>
	</div>
