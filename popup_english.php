	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="popup.php">
				...
				<span align="justify" class="input100"  type="text">Thank you for your interest in our products! Due to the large number of order we are having some difficulties. Please let us if you are interested. We will send you an email, as soon as we have stock, alongside an offer ticket just for you! </span>
				<br><br><br>
			...
			<div class="contact100-more">
				Any doubts?<span class="contact100-more-highlight">+34 693 430 654</span> Contact us
			</div>

			<div class="contact100-more" >
				<a class="contact100-more-highlight" href="index_english.php"> Take me home</a>
			</div>
		</div>
	</div>
